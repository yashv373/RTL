...
- when u have multiple statements giving stimulus to dut, in tb, between last statement and the $finish statement always add an additional time delay for it to make sure that the last statement executes and there 