...
---
- $ monitor, is only able to the change in values for a port, if the stimulus given at 2 consecutive time points in the TB is the same, it will not show that in the outpu