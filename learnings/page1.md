...
- if you want to use always@(*) then make sure that you have declared the output ports as registers (in verilog. system-verilog's logic datatype takes care of this internally)